 ...
 */
public class SortStepMyVersion
{
    ...
    public void sortMenu()
    {
        ...
        do
        {
            ...
            if ('1' <= choice.charAt(0) && choice.charAt(0) <= '5')
            {
                ...
                System.out.print("How many numbers per sample do you wish to generate? ");
    ...
    {
        SortStepMyVersion doSorts = new SortStepMyVersion();
